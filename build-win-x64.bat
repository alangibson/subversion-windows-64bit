...
python gen-make.py --vsnet-version=2008 -t vcproj ^
...
::%PYTHON_33_64_HOME%\python.exe setup_build_win_x86.py bdist_wheel --platform=win32 ^
::  --pycxx-dir=..\Import\pycxx-%PYCXX_VERSION% ^
::  --svn-inc-dir=%SVN_BIN_DIR%\include ^
::  --svn-lib-dir=%SVN_BIN_DIR%\lib ^
::  --svn-bin-dir=%SVN_BIN_DIR%\bin ^
::  --apr-inc-dir=%SVN_BIN_DIR%\include\apr ^
::  --apu-inc-dir=%SVN_BIN_DIR%\include\apr-util ^
::  --apr-lib-dir=%SVN_BIN_DIR%\lib\apr
...
rmdir /q /s pysvn
rmdir /q /s pysvn-1.7.8.dist-info
